...
class PromisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promise" do
    assert_difference('Promise.count') do
      post promises_url, params: { promise: { description: @promise.description, price: @promise.price } }
    end
  ...
  test "should update promise" do
    patch promise_url(@promise), params: { promise: { description: @promise.description, price: @promise.price } }
