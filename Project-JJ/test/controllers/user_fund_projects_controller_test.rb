...
class UserFundProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_fund_project" do
    assert_difference('UserFundProject.count') do
      post user_fund_projects_url, params: { user_fund_project: { project_id: @user_fund_project.project_id, user_id: @user_fund_project.user_id } }
    end
  ...
  test "should update user_fund_project" do
    patch user_fund_project_url(@user_fund_project), params: { user_fund_project: { project_id: @user_fund_project.project_id, user_id: @user_fund_project.user_id } }
